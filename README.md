...
**Status:** Phase 4 — Adaptive Memory. Recall Platform is frozen at `v0.2.0-recall-api-freeze`; Memory Evolution contracts are frozen at `v0.3.9-memory-evolution-freeze`; Adaptive Memory Foundation is frozen at `v0.4.9-adaptive-memory-foundation`.
...
See `docs/ROADMAP.md` for the current roadmap, `RELEASE-v0.2.0.md` for the Recall API freeze, `docs/releases/v0.3.9-memory-evolution-freeze.md` for the Memory Evolution freeze, and `docs/releases/v0.4.9-adaptive-memory-foundation.md` for the Adaptive Memory Foundation freeze.
