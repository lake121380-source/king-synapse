...
Current decision: `protocol_ready_waiting_for_independent_annotation`. No human-independent claim-level submissions, adjudicated labels, Judge precision/recall, held-out access, Provider calls, scorer changes, learning, persistence, Hermes, or runtime authority are claimed.
