...
pub use algorithms::{
    ...
    forget_precision_report, hebbian_consistency_report, long_horizon_cognitive_memory_report,
    merge_precision_report, predictive_trace_report, reflection_yield_report,
    trace_reinforcement_report,
};
