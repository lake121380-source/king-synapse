...
pub use working_memory::{
    ...
    NoOpSink, NoOpStoreAdapter, NoOpStoreMutationDispatcher, NoOpStoreSink,
    ...
    ReflectionWarning, SessionId, SkippedEdgeUpdate, SkippedReflectionAction, StoreAdapter,
    StoreExecutionReport, StoreMutation, StoreMutationDispatcher, StoreMutationPlan, StoreSink,
