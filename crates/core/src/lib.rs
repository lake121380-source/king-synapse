...
pub use recall::{
    BoosterContext, GraphActivationBooster, LatentActivationHit, LatentActivationProbe,
    NoOpBooster, QueryEmbedder, RecallBooster, RecallEngine, RecallHit, RecallSource,
    DEFAULT_RERANK_POOL,
};
