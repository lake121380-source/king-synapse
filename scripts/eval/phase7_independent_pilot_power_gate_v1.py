...
ANALYSIS_PROTOCOL = C / "phase7_3_3_d_independent_pilot_analysis_protocol_v1.json"
ANALYSIS_MANIFEST = R / "phase7_3_3_d_independent_pilot_analysis_execution_manifest_v1.json"
ANALYSIS_REPORT = R / "phase7_3_3_d_independent_pilot_analysis_report_v1.json"
ANALYSIS_RECEIPT = R / "phase7_3_3_d_independent_pilot_analysis_freeze_receipt_v1.json"
STATE_PREV = D / "phase7_3_3_d_support_stage_state_v20.json"
READY_PREV = R / "phase7_3_3_d1_reference_construction_readiness_v31.json"

METHOD = C / "phase7_3_3_d_independent_pilot_power_method_v1.json"
MANIFEST = R / "phase7_3_3_d_independent_pilot_power_gate_manifest_v1.json"
REPORT = R / "phase7_3_3_d_independent_pilot_power_gate_report_v1.json"
SAMPLE = R / "phase7_3_3_d_independent_pilot_sample_size_freeze_v1.json"
RECEIPT = R / "phase7_3_3_d_independent_pilot_power_gate_receipt_v1.json"
STATE = D / "phase7_3_3_d_support_stage_state_v21.json"
READY = R / "phase7_3_3_d1_reference_construction_readiness_v32.json"
...
def preflight_checks():
    ...
    return {
        ...
        "analysis_frozen": analysis["status"] == "frozen_exploratory_pilot_result",
        ...
        "authorized_stage": state["next_authorized_stage"] == "freeze_independent_pilot_power_method_v1"
        and readiness["next_authorized_stage"] == "freeze_independent_pilot_power_method_v1",
...
def method_document():
    ...
    return {
        "schema_version": 1,
        "method_id": "phase7.3.3-d-independent-pilot-power-method-v1",
...
def freeze_method():
    ...
    manifest = {
        "schema_version": 1,
        "manifest_id": "phase7.3.3-d-independent-pilot-power-gate-manifest-v1",
        ...
        "artifact_sha256": {
            ...
            "state_v20": digest(STATE_PREV),
            "readiness_v31": digest(READY_PREV),
        },
...
def frozen_input_checks():
    ...
    return {
        ...
        "previous_state": manifest["artifact_sha256"]["state_v20"] == digest(STATE_PREV),
        "previous_readiness": manifest["artifact_sha256"]["readiness_v31"] == digest(READY_PREV),
...
def execute_gate():
    ...
    report = {
        "schema_version": 1,
        "report_id": "phase7.3.3-d-independent-pilot-power-gate-report-v1",
    ...
    sample = {
        "schema_version": 1,
        "freeze_id": "phase7.3.3-d-independent-pilot-sample-size-freeze-v1",
    ...
    receipt = {
        "schema_version": 1,
        "receipt_id": "phase7.3.3-d-independent-pilot-power-gate-receipt-v1",
    ...
    state_lineage.update(
        {
            "support_stage_state_v20_sha256": digest(STATE_PREV),
            "readiness_v31_sha256": digest(READY_PREV),
            "independent_pilot_power_method_v1_sha256": digest(METHOD),
            "independent_pilot_power_gate_manifest_v1_sha256": digest(MANIFEST),
            "independent_pilot_power_gate_report_v1_sha256": report_hash,
            "independent_pilot_sample_size_freeze_v1_sha256": sample_hash,
            "independent_pilot_power_gate_receipt_v1_sha256": receipt_hash,
        }
    )
    state = {
        "schema_version": 21,
        "state_id": "phase7.3.3-d-support-stage-state-v21",
        ...
        "runtime_integration_authorized": False,
        "independent_replication_state": "independent_pilot_power_infeasible_current_single_claim_frame",
        "independent_pilot_analysis_completed": True,
        "independent_pilot_power_method_frozen": True,
        "independent_pilot_power_gate_completed": True,
    ...
    ready_lineage.update(
        {
            "readiness_v31_sha256": digest(READY_PREV),
            "support_stage_state_v20_sha256": digest(STATE_PREV),
            "power_method_v1_sha256": digest(METHOD),
            "power_gate_manifest_v1_sha256": digest(MANIFEST),
            "power_gate_report_v1_sha256": report_hash,
            "sample_size_freeze_v1_sha256": sample_hash,
            "power_gate_receipt_v1_sha256": receipt_hash,
            "support_stage_state_v21_sha256": state_hash,
        }
    )
    readiness = {
        "schema_version": 42,
        "readiness_id": "phase7.3.3-d1-reference-construction-readiness-v32",
        ...
        "dual_arm_status": "v4_completed_equal_resource_scored",
        "analysis_status": "frozen_exploratory_pilot_result",
        "power_gate_status": "frozen_power_infeasible_current_single_claim_frame",
        "sample_size_candidates": None,
        "confirmatory_opening_authorized": False,
        "next_authorized_stage": "final_audit_independent_pilot_chain_v1",
        "confirmatory_dataset_opened": False,
        ...
        json.dumps(
            {
                ...
                "state_v21_sha256": state_hash,
                "readiness_v32_sha256": readiness_hash,
                "sample_size_candidates": None,
                "confirmatory_dataset_opened": False,
            },
            indent=2,
...
def verify():
    ...
    checks = {
        ...
        "state_v21": state["independent_pilot_power_gate_completed"] is True
        and state["next_authorized_stage"] == "final_audit_independent_pilot_chain_v1",
        "readiness_v32": readiness["power_gate_status"] == "frozen_power_infeasible_current_single_claim_frame"
        ...
        json.dumps(
            {
                ...
                "hashes": {
                    ...
                    "state_v21": digest(STATE),
                    "readiness_v32": digest(READY),
                },
            },
            indent=2,
        )
