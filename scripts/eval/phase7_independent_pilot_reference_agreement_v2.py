#!/usr/bin/env python3
"""Freeze and compute Independent Pilot Reference Agreement v2."""
...
PROTOCOL=CONFIG/'phase7_3_3_d_independent_pilot_reference_agreement_protocol_v2.json'
FIXTURES=REPORTS/'phase7_3_3_d_independent_pilot_reference_agreement_contract_fixtures_v2.json'
MANIFEST=REPORTS/'phase7_3_3_d_independent_pilot_reference_agreement_manifest_v2.json'
REPORT=REPORTS/'phase7_3_3_d_independent_pilot_reference_agreement_report_v2.json'
WORKLIST=DATA/'phase7_3_3_d_independent_pilot_reference_disagreement_worklist_v2.json'
OUTCOME=REPORTS/'phase7_3_3_d_independent_pilot_reference_agreement_outcome_v2.json'
RECEIPT=REPORTS/'phase7_3_3_d_independent_pilot_reference_agreement_freeze_receipt_v2.json'
...
def freeze():
 ...
 man={'schema_version':1,'manifest_id':'phase7.3.3-d-independent-pilot-reference-agreement-manifest-v2','status':'frozen_before_computation','protocol_sha256':ph,'fixtures_sha256':fh,'adapter_sha256':sha(Path(__file__)),'input_sha256':{'reviewer_a':sha(A),'reviewer_b':sha(B),'selected_dataset':sha(DATASET),'reference_policy':sha(POLICY)},'expected_case_count':40,'provider_calls_authorized':0,'route_a_gold_visible':False,'arm_outputs_visible':False,'confirmatory_content_opened':False}
...
def compute():
 ...
 for cid in order:
  src=ds[cid];aa=am[cid];bb=bm[cid];ca=aa['claims'][0];cb=bb['claims'][0];candidate=src['candidate_text']; n=len(candidate)
