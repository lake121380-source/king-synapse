#!/usr/bin/env python3
"""Freeze and execute independent Phase 7.3.3-D1-A v3 occurrence-aware protocol-owned-role Boundary reviewers.
...
ATTEMPT_LOG = REPORTS / "phase7_3_3_d_boundary_reviewer_execution_attempts_v3.jsonl"
FIXTURE_REPORT = REPORTS / "phase7_3_3_d_boundary_reviewer_contract_fixtures_v3.json"

REVIEWERS = {
    "a": {"model": "gpt-4.1", "manifest": REPORTS / "phase7_3_3_d_boundary_reviewer_a_execution_manifest_v3.json"},
    "b": {"model": "qwen3.5-plus", "manifest": REPORTS / "phase7_3_3_d_boundary_reviewer_b_execution_manifest_v3.json"},
}
