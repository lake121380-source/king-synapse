...
def build_report(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        ...
        "read": {
            ...
            "next_action": (
                "Do not change runtime defaults. If judge authorization is fixed, "
                "judge-score the top-context candidate; otherwise continue with "
                "validation-only generator diagnostics or hosted external comparison."
            ),
        },
        "limits": [
