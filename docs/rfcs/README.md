...
| RFC-014 | Forgetting Algorithm | Draft (`v0.8.0` skeleton, `v0.8.1` NoOp, `v0.8.2` rule-based reference, `v0.8.3` benchmark implemented) |
...
skeleton, NoOp, rule-based reference, and benchmark milestones through
`v0.8.3`.
