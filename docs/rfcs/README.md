...
| RFC-012 | Reflection Algorithm | Draft (`v0.6.0` skeleton, `v0.6.1` NoOp, `v0.6.2` deterministic reference, `v0.6.3` benchmark, `v0.6.4` processing adapter, `v0.6.5` store mutation plan implemented) |
